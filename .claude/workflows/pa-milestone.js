...
Known pre-existing failures that are NOT yours to fix and NOT blockers: the ProviderCommandReactor "serializes concurrent distinct turn starts" test, three web typecheck diagnostics (attachment union, branded Prime driver index, readonly test mutation), server typecheck OOM exit 137.
