...
function isRecord(v) {
  ...
  if (
    r.phase !== void 0 &&
    !["active", "stopping", "stopped", "sessions-cleaned", "resources-cleaned"].includes(r.phase)
  )
    return false;
  if (r.process !== void 0) {
...
const writePrimeOwnership = async (path, record) => {
  ...
  if (
    ...
    (record.kind === "daemon" ? record.rpcSessionId !== void 0 : record.daemonSessionId !== void 0)
  )
