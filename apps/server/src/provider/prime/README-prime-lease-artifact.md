...
SHA-256: `716f8fac4560e39abec8dc8b2d18c7153a155b02c7718c80152afd897855b842`.
...
The verifier reports 155 source-derived assertions and a race trace covering:
...
- **adapter gate** — the gate the Prime adapter is wired to refuses activation with the same redacted typed receipt and an error message that names no owner;
