...
describe("primeResourceLayout", () => {
  it("makes two homes and instances disjoint while retaining deterministic scoped paths", async () => {
    ...
    const first = primeResourceLayout({
      home: one,
      environmentId: "env/a",
      instanceId: "instance",
      threadId: "thread",
    });
    const again = primeResourceLayout({
      home: one,
      environmentId: "env/a",
      instanceId: "instance",
      threadId: "thread",
    });
    const second = primeResourceLayout({
      home: two,
      environmentId: "env/a",
      instanceId: "instance",
      threadId: "thread",
    });
    const otherInstance = primeResourceLayout({
      home: one,
      environmentId: "env/a",
      instanceId: "other",
      threadId: "thread",
    ...
    const hostile = primeResourceLayout({
      home: one,
      environmentId: "../%/é",
      instanceId: "/",
      threadId: "..x",
    ...
    assert.notStrictEqual(
      primeResourceLayout({ home: one, environmentId: "/", instanceId: "x", threadId: "t" })
        .ownership,
      primeResourceLayout({ home: one, environmentId: "%2F", instanceId: "x", threadId: "t" })
        .ownership,
    );
    assert.throws(() =>
      primeResourceLayout({ home: one, environmentId: ".", instanceId: "x", threadId: "t" }),
